                    ...
                    <?= GridView::widget([
                        ...
                        'columns' =>[
                            ...
                            [
                                ...
                                'value'=> function($data){
                                    //超链接
                                    return Html::a($data->username, ['view', 'id' => $data->id], ['class' => 'profile-link','title' => '查看']);
                                },
                                'filter'=>Html::activeTextInput($searchModel, 'username',['class'=>'form-control','placeholder'=>'请输入管理员账号过滤']),
                            ],
                            [
                                'attribute'=>'upd_time',
                                'value'=>'upd_time',
